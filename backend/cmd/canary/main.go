...
import (
	...
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/admin"
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/config"
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/core"
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/event"
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/geoip"
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/health"
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/middleware"
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/notify"
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/notify/telegram"
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/notify/webhook"
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/server"
	...
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/token/generators/registry"
	"github.com/CosmicCoder-X/canary-token-generator/backend/internal/turnstile"
)
